export default [
  {id:"firstName", coreData: true, label:"First Name"},
  {id:"middleName", coreData: true, label:"Middle Name"},
  {id:"lastName", coreData: true, label:"Last Name"},
  {id:"ssn", coreData: true, label:"SSN", validation:"ssn", mask:"###-##-####"},
  {id:"phone", label:"Phone", validation:"phone"},
  {id:"email", coreData: true, label:"Email", validation:"email", fieldType:'email'},
  ...
  {id:"dateOfBirth", coreData: true, label:"Date of Birth", mask:"##/##/####"},
