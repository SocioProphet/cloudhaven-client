      ...
      <v-toolbar flat >
        ...
        >
          ...
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text elevation="1" @click="close">Cancel</v-btn>
              <v-btn color="blue darken-1" text elevation="1"@click="save">Save</v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-text style="text-align:center" class="text-h5">Are you sure you want to delete this {{titleName.toLowerCase()}}?</v-card-text>
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text @click="closeDelete" elevation="1">Cancel</v-btn>
              <v-btn color="blue darken-1" text @click="deleteItemConfirm" elevation="1">OK</v-btn>
              <v-spacer></v-spacer>
            </v-card-actions>
          </v-card>
        </v-dialog>
